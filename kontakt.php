...
<body>
    ...
    <div class="container">
        ...
        <div class="formular_pozadie">
            ...
            <br><br>
            <form class="formular" action="thankyou.php" method="POST">
                <div class="form-group justify-content-center">
                    <label class="formular_label">Meno a priezvisko</label>
                    <input name="meno" placeholder="Vaše meno" type="text" class="form-control formular_input" required>
                </div>
                <div class="form-group">
                    <label class="formular_label">E-mail</label>
                    <input name="email" type="email" id="emailInput" class="form-control formular_input" placeholder="meno@mail.com" required>
                </div>
                <div class="form-group">
                    <label class="formular_label">Požiadavka</label>
                    <textarea name="text" placeholder="Správa" class="form-control formular_textarea" rows="3" required></textarea>
                </div>
                <div class="form-check">
                    <input name="potvrdenie" type="checkbox" value="1" id="consentCheckbox" class="form-check-input formular_input" required>
                    <label class="form-check-label formular_input">Súhlas so spracovaním osobných údajov</label>
                </div>
                <input type="submit" name="odoslane" value="Odoslať" class="btn btn-primary">
            </form>
        </div>
    <br><br>
    <!-- Päta stránky -->
